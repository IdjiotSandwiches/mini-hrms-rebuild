    ...
    ">
        ...
        <div class="select-none grid">
            @if (auth()->guard('admin')->check())
                @include('components.dropdown-item', with(['name' => 'Users Report', 'path' => 'admin.dashboard']))
                @include('components.dropdown-item', with(['name' => 'Users Management', 'path' => 'admin.dashboard']))
            @else
