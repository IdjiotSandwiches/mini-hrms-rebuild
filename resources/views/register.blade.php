...
@section('content')
    <form action="{{ route('register') }}" method="POST" class="grid gap-5 w-1/3">
        @csrf
        ...
        <p class="text-center text-sm">
            ...
            <a href="{{ route('login-page') }}" class="font-semibold leading-6 text-blue-600 transition-colors hover:text-blue-500 underline decoration-2 underline-offset-2">Login</a>
        </p>
    </form>
@endsection
